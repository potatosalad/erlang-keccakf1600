...
/* keccakf1600_nif:spongerng_init_from_buffer/2 */

static ERL_NIF_TERM
keccakf1600_nif_spongerng_init_from_buffer_2(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    ...
    ctx = keccakf1600_nif_alloc_spongerng_ctx(env);
    if (ctx == NULL) {
        return enif_make_badarg(env);
    }
...
/* keccakf1600_nif:spongerng_init_from_file/3 */

static ERL_NIF_TERM
keccakf1600_nif_spongerng_init_from_file_3(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    decaf_keccak_prng_s ctxbuf;
    decaf_keccak_prng_s *ctx = &ctxbuf;
    ErlNifBinary input;
...
/* keccakf1600_nif:spongerng_init_from_dev_urandom/0 */

static ERL_NIF_TERM
keccakf1600_nif_spongerng_init_from_dev_urandom_0(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    decaf_keccak_prng_s ctxbuf;
    decaf_keccak_prng_s *ctx = &ctxbuf;
    ERL_NIF_TERM out_term;
...
/* keccakf1600_nif:spongerng_next/2 */

static ERL_NIF_TERM
keccakf1600_nif_spongerng_next_2(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    ...
    if (argc != 2 || !keccakf1600_nif_get_spongerng_ctx(env, argv[0], &old_ctx) || !enif_get_ulong(env, argv[1], &outlen)) {
        return enif_make_badarg(env);
    }

    new_ctx = keccakf1600_nif_alloc_spongerng_ctx(env);
    if (new_ctx == NULL) {
        return enif_make_badarg(env);
    }
...
/* keccakf1600_nif:spongerng_stir/2 */

static ERL_NIF_TERM
keccakf1600_nif_spongerng_stir_2(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    decaf_keccak_prng_s *old_ctx = NULL;
    decaf_keccak_prng_s *new_ctx = NULL;
    ErlNifBinary input;
    ...
    if (argc != 2 || !keccakf1600_nif_get_spongerng_ctx(env, argv[0], &old_ctx) ||
