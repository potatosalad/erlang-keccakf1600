...
init_per_group(G='spongerng_init_from_buffer', Config) ->
	EmptySponge = keccakf1600_spongerng:init_from_buffer(<<>>, true),
	SeedSponge = keccakf1600_spongerng:init_from_buffer(<<
	...
	[
		...
		| keccakf1600_ct:start(G, Config)
	];
init_per_group(G='spongerng_init_from_file', Config) ->
	DataDir = ?config(data_dir, Config),
	SeedSponge = keccakf1600_spongerng:init_from_file(filename:join(DataDir, "seed.txt"), 1406, true),
	[
		{spongerng_seed_deterministic, [
			{SeedSponge, [
